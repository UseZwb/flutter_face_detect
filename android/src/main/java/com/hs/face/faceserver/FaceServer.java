package com.hs.face.faceserver;
...
import com.hs.face.model.FaceRegisterInfo;
...
public class FaceServer {
    public static String ROOT_DIR = Environment.getExternalStorageDirectory() + "/SchoolFacePay";//人脸识别照片根路径
    public static final String REGISTER_DIR = ROOT_DIR;
